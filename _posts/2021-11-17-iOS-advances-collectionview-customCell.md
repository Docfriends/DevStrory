---
layout: post
title: "Advances CollectionView - CustomCell로 구성해보기"
description: "Diffable DataSource, CustomCell로 구성해서 프로젝트 진행해봅니다."
date: 2021-11-17
tags: [iOS, WWDC, Diffable DataSource, Modern Cell Configuration, CustomCell]
writer: zehye
category: iOS
comments: true
share: true
...
![Compositional Layout]({{ site.url }}{{ site.baseurl }}/images/2021/iOS/layout1.png)
...
![Compositional Layout]({{ site.url }}{{ site.baseurl }}/images/2021/iOS/layout2.png)
