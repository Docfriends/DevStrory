---
layout: post
title: "iOS FSCalendar 써본 것 모두다 싹다! 정리해보기"
description: "iOS FSCalendar에서 사용해본 모든 것을 정리해보았습니다."
date: 2022-06-09
tags: [Swift, iOS, Docstep, FSCalendar]
writer: zehye
category: iOS
comments: true
share: true
...
달력을 구현함에 있어서 FSCalendar라는 라이브러리를 사용한 경험이 있었습니다. <br>
...
처음에 "아니 이거 사용하려면 스택오버플로우에 이런 함수있다는데.. 대체 왜!! 왜 나는 안불러져 오는거지..?!" 했는데

FSCalendarDelegateAppearance 채택을 하지 않았었습니다..ㅎㅎ
